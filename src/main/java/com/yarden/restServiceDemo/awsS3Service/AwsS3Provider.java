...
public class AwsS3Provider {
    ...
    public static String uploadFileToS3(String fileNameInBucket, String localFileName){
        ...
        s3Client.putObject(new PutObjectRequest(System.getenv("SDK_REPORTS_S3_BUCKET"), fileNameInBucket, new File(localFileName)).withCannedAcl(CannedAccessControlList.PublicRead));
        return s3Client.getUrl(System.getenv("SDK_REPORTS_S3_BUCKET"), fileNameInBucket).toString();
    }
