...
public class SheetDBApiService {
    ...
    public static void updateSheet(SheetData sheetData) throws IOException {
        getService().spreadsheets().values()
                .update(sheetData.getSheetTabIdentifier().spreadsheetID, sheetData.getSheetTabIdentifier().sheetTabName + "!A1:BA1000", new ValueRange().setValues(jsonArrayToList(sheetData.getSheetData(), sheetData.getColumnNames())))
